...
milestone_neighbors: 57
milestone_pledged: "$2.1M"
milestone_tagline: "Amazing neighbors make neighborhoods amazinger."
---
...
<div class="anchor-progress">
  <div class="anchor-icons">
    <svg class="anchor-icon anchor-icon--committed" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 30" width="36" height="45" aria-hidden="true"><circle cx="12" cy="4.5" r="3" stroke="currentColor" stroke-width="2" fill="none"/><line x1="12" y1="7.5" x2="12" y2="27" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><line x1="3" y1="13" x2="21" y2="13" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M3 19.5 Q1 27 8.5 27" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round"/><path d="M21 19.5 Q23 27 15.5 27" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round"/></svg>
    <svg class="anchor-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 30" width="36" height="45" aria-hidden="true"><circle cx="12" cy="4.5" r="3" stroke="currentColor" stroke-width="2" fill="none"/><line x1="12" y1="7.5" x2="12" y2="27" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><line x1="3" y1="13" x2="21" y2="13" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M3 19.5 Q1 27 8.5 27" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round"/><path d="M21 19.5 Q23 27 15.5 27" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round"/></svg>
    <svg class="anchor-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 30" width="36" height="45" aria-hidden="true"><circle cx="12" cy="4.5" r="3" stroke="currentColor" stroke-width="2" fill="none"/><line x1="12" y1="7.5" x2="12" y2="27" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><line x1="3" y1="13" x2="21" y2="13" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M3 19.5 Q1 27 8.5 27" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round"/><path d="M21 19.5 Q23 27 15.5 27" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round"/></svg>
    <svg class="anchor-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 30" width="36" height="45" aria-hidden="true"><circle cx="12" cy="4.5" r="3" stroke="currentColor" stroke-width="2" fill="none"/><line x1="12" y1="7.5" x2="12" y2="27" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><line x1="3" y1="13" x2="21" y2="13" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M3 19.5 Q1 27 8.5 27" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round"/><path d="M21 19.5 Q23 27 15.5 27" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round"/></svg>
    <svg class="anchor-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 30" width="36" height="45" aria-hidden="true"><circle cx="12" cy="4.5" r="3" stroke="currentColor" stroke-width="2" fill="none"/><line x1="12" y1="7.5" x2="12" y2="27" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><line x1="3" y1="13" x2="21" y2="13" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><path d="M3 19.5 Q1 27 8.5 27" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round"/><path d="M21 19.5 Q23 27 15.5 27" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round"/></svg>
  </div>
  <p class="anchor-progress-label">One anchor investor is in!</p>
</div>
...
The nonprofit – provisionally the Downtown Loyal Heights Trust – is run by neighbors. Its members are Loyal Heights residents who own shares in the company, and they elect the Trust's board. That board is small and focused on the long view: what kind of place we want this corner to be, decades from now.
...
The point of all this structure is to make sure the growth that's coming attracts investment that benefits our neighborhood for the long term. The details of all of this – board sizes, what counts as a major decision, how voting works – will need to be worked out with counsel, anchors, and neighbors.
...
- [NorthEast Investment Cooperative](https://www.neic.coop) in Northeast Minneapolis was founded in 2011 by neighbors who were tired of watching property in their neighborhood sit poorly used. It's often cited as the first commercial-property investment cooperative in the U.S. Members buy a $1,000 share, get one vote, and the co-op has bought, rehabbed, and leased multiple buildings since.
- [NYC Real Estate Investment Cooperative](http://nycreic.com) launched in 2015 in Brooklyn and grew to several hundred members pooling capital to buy commercial property in New York. Same one-member-one-vote structure as the NorthEast Investment Cooperative.
- [Vermont Real Estate Cooperative](https://vrec.coop) incorporated in 2020 and acquired its first commercial property shortly after. Vermont residents buy in at $1,000 a share, get one vote regardless of how many shares they hold, and elect a seven-seat board that decides what to acquire.
...
People will be upset about it no matter what. Again, we already boast a [Walk Score of 73](https://www.walkscore.com/WA/Seattle/Loyal_Heights). We should aim for 100.
...
- [All firms are cooperatives – and so are governments](http://dx.doi.org/10.5947/jeod.2013.007) by Henry Hansmann
- [*Systems of Survival*](https://en.wikipedia.org/wiki/Systems_of_Survival) by Jane Jacobs
- [*Seeing Like a State*](https://en.wikipedia.org/wiki/Seeing_Like_a_State) by James C. Scott
